...
import textwrap
import numpy as np
badindices=range(0,13)+[14,16,21,22,25,28,29]+range(32,45)+[46,51,52,53]+range(69,78)+[84,87,88,89,90,126,133,184,185,189,191,193,199,211,243,244,245,253,270,271,288,297,298,299,314,403]+[213,219,231,320,323,376,447,459]+[340,388,413,455,461,492,501,522,533,539,549,568,576,581,590,596,617,622,628,633,644,649]
